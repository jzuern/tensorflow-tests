...
execute_process(
  COMMAND "/usr/bin/git" show-ref 50893291621658f355bc5b4d450a8d06a563053d
  WORKING_DIRECTORY "/home/jzuern/Dropbox/develop/hiwi_mrt/cmake/testproj/build/zlib/src/zlib"
...
if("${show_ref_output}" MATCHES "refs/remotes/50893291621658f355bc5b4d450a8d06a563053d")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "50893291621658f355bc5b4d450a8d06a563053d")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "50893291621658f355bc5b4d450a8d06a563053d")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 50893291621658f355bc5b4d450a8d06a563053d
  WORKING_DIRECTORY "/home/jzuern/Dropbox/develop/hiwi_mrt/cmake/testproj/build/zlib/src/zlib"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jzuern/Dropbox/develop/hiwi_mrt/cmake/testproj/build/zlib/src/zlib/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jzuern/Dropbox/develop/hiwi_mrt/cmake/testproj/build/zlib/src/zlib/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
